...
import uk.gov.hmrc.test.ui.pages.{FeatureSwitchPage, IndexPage}

class CheckJourneySpec extends BaseSpec {

  Feature("Check journey") {
    Scenario("User checks for their software compatibility") {
      ...
      //TODO uncomment when next page is available
