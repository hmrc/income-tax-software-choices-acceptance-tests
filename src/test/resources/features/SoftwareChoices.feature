...
Feature: Software Choices
  ...
  Scenario: User has selected options which mean no software vendor supports all their needs in an all in one product and they elect to browse anyway.
    When I am on the business income page, I select the following business income and click continue
      | Self-employment  |
      | UK property      |
      | Foreign property |
  ...
  Scenario: User has selected options which mean no software vendor supports all their needs in an all in one product and they click finish.
    When I am on the business income page, I select the following business income and click continue
      | Self-employment  |
      | UK property      |
      | Foreign property |
