...
Then execute the `run_tests.sh` script:
    ...
    ./scripts/run_tests --browser=<browser-driver> --staging
    ./scripts/run_tests --browser=<browser-driver> --qa
...
./scripts/run_tests --browser=remote-chrome
```
...
For example, to execute the `run_tests.sh` script using Chrome remote-webdriver against QA environment
    ...
    ./scripts/run_tests --browser=remote-chrome --qa
